...
// CoursModels needs to be found in the hashmap, which should be implemented in main function;
// After search, remove the elements in courseDone from preRequisiteList
// Maybe hashmap is a betterway to implement
